...
import { getAllinvoices, getInvoiceByParamsController, getInvoiceByIDController, getInvoiceReportController, getInvoiceByIDNaturalKeyController} from '../controllers/invoicesSupplierController.js';
...
router.get('/:id/naturalkey', getInvoiceByIDNaturalKeyController); // Rota para obter a fatura específica pelo ID
